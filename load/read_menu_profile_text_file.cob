...
PROGRAM-ID.    read_menu_profile_text_file.
AUTHOR.        Duma.
*>----------------------------------------------------------------------
*> Object: Generate menu_profile file from text file
*>
*> Read...: menu_profile.txt
*>
*> Out....: menu_profile.dat
*>
*>----------------------------------------------------------------------
...
FD  FILE_TXT
    VALUE OF FILE-ID IS  "../txt/menu_profile.txt".
...
01  WK-SCR01-1                    PIC  X(057) VALUE
    "GENERATE MENU PROFILE FILE FROM FILE IN TXT FORMAT".
01  WK-SCR01-2.
    03  WK-SCR-DATE.
