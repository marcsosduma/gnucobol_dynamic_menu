...
PROGRAM-ID.    read_user_text_file.
AUTHOR.        Duma.
*>----------------------------------------------------------------------
*> Object: Generate USER file from text file
*>
*> Read...: user.txt
*>
*> Out....: USER.dat
...
FD  FILE_TXT
    VALUE OF FILE-ID IS  "../txt/user.txt".
01  REC-TXT                       PIC  X(24).
...
01  WK-SCR01-1                    PIC  X(057) VALUE
    "GENERATE USER FILE FROM FILE IN TXT FORMAT".
01  WK-SCR01-2.
    03  WK-SCR-DATE.
             ...
             NOT AT END
                ...
                IF REC-TXT(1:5)<>SPACES
                    ...
                    INVALID KEY 
                        ...
                        MOVE ST-USR TO WK-MSG(61:02)
                        DISPLAY SS-MSG
                        CLOSE FILE_TXT FD-USER
                        STOP RUN
                    NOT INVALID KEY
                        display WK-READS line 02 column 08
