...
PROGRAM-ID.    read_user_profile_text_file.
AUTHOR.        Duma.
*>----------------------------------------------------------------------
*> Object: Generate user_profile file from text file
*>
*> Read...: user_profile.txt
*>
*> Out....: user_profile.dat
*>
*>----------------------------------------------------------------------
...
FD  FILE_TXT
    VALUE OF FILE-ID IS  "../txt/user_profile.txt".
...
01  WK-SCR01-1                    PIC  X(057) VALUE
    "GENERATE USER PROFILE FILE FROM FILE IN TXT FORMAT".
01  WK-SCR01-2.
    03  WK-SCR-DATE.
