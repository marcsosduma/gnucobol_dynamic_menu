...
PROGRAM-ID.    read_menu_text_file.
AUTHOR.        Duma.
*>----------------------------------------------------------------------
*> Object: Generate menu file from text file
*>
*> Read...: menu.txt
*>
*> Out....: menu.dat
...
FD  FILE_TXT
    VALUE OF FILE-ID IS  "../txt/menu.txt".
...
01  WK-SCR01-1                    PIC  X(057) VALUE
    "GENERATE MENU FILE FROM FILE IN TXT FORMAT".
01  WK-SCR01-2.
    03  WK-SCR-DATE.
             ...
             NOT AT END
                ...
                IF REC-TXT(1:5)<>SPACES
                    ...
                    INVALID KEY 
                        ...
                        MOVE ST-MNU TO WK-MSG(61:02)
                        DISPLAY SS-MSG
                        CLOSE FILE_TXT FD-MENU
                        STOP RUN
                    NOT INVALID KEY
                        display WK-READS line 02 column 08
